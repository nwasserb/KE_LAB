...
data = pd.DataFrame({
        "port1_.05Delay" : relPort1mW,
        "port2_.05Delay" : relPort2mW,
        "port3_.05Delay" : relPort3mW,
        "port4_.05Delay" : relPort4mW,
})
data.to_csv('Characterizing_.05delay.csv',  mode='a',index=False)  
